...
execute if score DrawCircle.CurrentStep KzeMapSimplification < DrawCircle.Steps KzeMapSimplification run function kms:internal/draw/circle/horizontal_loop